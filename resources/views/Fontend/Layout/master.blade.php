...
<body class="header-sticky page-loading" style="overflow-x: hidden">
                                    ...
                                    <div class="widget widget_text">
                                        <div class="textwidget">
                                            <div class="custom-info">
                                                ...
                                                <span><i class="fa fa-reply"></i><a href="" class="__cf_email__"
    ...
    <script type="text/javascript" src="{{ asset('public/Fontend/javascript/owl.carousel.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('public/Fontend/javascript/gmap3.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('public/Fontend/javascript/parallax.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('public/Fontend/javascript/jquery-validate.js') }}"></script>
    <script type="text/javascript" src="{{ asset('public/Fontend/javascript/main.js') }}"></script>

    <script type="text/javascript" src="{{ asset('public/Fontend/javascript/jquery.themepunch.tools.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('public/Fontend/javascript/jquery.themepunch.revolution.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('public/Fontend/javascript/slider.js') }}"></script>
</body>
